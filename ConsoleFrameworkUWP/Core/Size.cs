...
namespace ConsoleFramework.Core
{
    public sealed class Size
    {
        ...
        public static bool /*operator ==*/ EqualsOp(Size size1, Size size2)
        {
            return ((size1.Width == size2.Width) && (size1.Height == size2.Height));
        }

        public static bool /*operator !=*/ NotEqualsOp(Size size1, Size size2)
        {
            return !(size1 == size2);
        }

        public static bool AreEqual(Size size1, Size size2)
        {
            if (size1.IsEmpty)
            {
        ...
        public bool Equivalent(Size size2)
        {
            return Equals(this, size2);
        }
        ...
        public static /*explicit operator*/ Vector ToVector(Size size)
        {
            return new Vector(size.width, size.height);
        }

        public static /*explicit operator*/ Point ToPoint(Size size)
        {
