...
namespace ConsoleFramework.Core
{
    ...
    internal sealed class Thickness : IEquatable<Thickness>
    {
        ...
        public static bool /*operator ==*/ EqualsOp(Thickness t1, Thickness t2)
        {
            return t1.left == t2.left && t1.top == t2.top && t1.right == t2.right && t1.bottom == t2.bottom;
        }

        public static bool /*operator !=*/ NotEqualsOp(Thickness t1, Thickness t2)
        {
            return !(Thickness.EqualsOp(t1, t2));
        }
