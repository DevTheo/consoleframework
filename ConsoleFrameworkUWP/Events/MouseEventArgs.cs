...
namespace ConsoleFramework.Events
{
    ...
    internal class MouseEventArgs : RoutedEventArgs
    {
        ...
        /// <summary>
        /// Âîçâðàùàåò ïðåîáðàçîâàííûå êîîðäèíàòû îòíîñèòåëüíî óêàçàííîãî êîíòðîëà.
        /// Åñëè êîíòðîë çàõâàòûâàåò ââîä, òî ïîëó÷àåìûå òàêèì îáðàçîì êîîðäèíàòû ìîãóò
        /// âûõîäèòü çà ïðåäåëû êîíòðîëà (îòðèöàòåëüíûå èëè áîëüøå ActualWidth/ActualHeight).
        /// </summary>
