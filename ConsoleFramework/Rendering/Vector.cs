...
namespace ConsoleFramework.Core
{
    public sealed class Vector
    {
        ...
        public static bool AreEqual(Vector vector1, Vector vector2)
        {
        ...
        public bool Equivalent(Vector value)
        {
        ...
        public static Vector /*operator +*/ AddOp(Vector vector1, Vector vector2)
        {
        ...
        public static Vector /*operator -*/ MinusOp(Vector vector1, Vector vector2)
        {
            return new Vector(vector1.x - vector2.x, vector1.y - vector2.y);
        }
        ...
        public static Point /*operator +*/ AddOpToPoint(Vector vector, Point point)
        {
